...
- **Nueva vista de reproducción:** al abrir o reproducir una canción aparece una nueva pantalla/interfaz de reproducción.
- **Cambió la interacción de reproducción:** ahora la canción se reproduce al tocar la foto, en lugar de al tocar el nombre.
- **Imágenes por defecto:** el sistema está usando imágenes genéricas precargadas en lugar de las imágenes específicas de cada canción.
